...
import { Compass, Heart, Map, UserRound, X, Check, GitCompareArrows, ArrowUpRight, Download, Upload } from 'lucide-react';
...
export function Shell(){
 const {saved,compare,trips,clearCompare,restore,notify,toast,storageError}=useStore();const location=useLocation();const [profile,setProfile]=useState(false);
