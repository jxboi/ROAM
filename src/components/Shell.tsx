...
export function Shell(){
 ...
 // Only announce a page that has actually arrived: a lazily loaded route is
 // still downloading when the path changes, and the store still holds the name
 // of the page being left.
 const arrived=currentPage.path===location.pathname?currentPage.title:'';
